...
$(document).ready(function(){
    $('.navbar_elements ul li a').click(function(){
        $('.navbar_elements ul li a').css('text-decoration','underline');
    });
});
...
$(document).mouseenter(function(){
    $('.card-image1').mouseenter(function(e){
        clip.play();
    })

})
$(document).mouseenter(function(){
    $('.card-image1').mouseout(function(e){
        clip.pause();
    })
